...
class ReportXml(models.Model):
    ...
    jasper_report = fields.Boolean('Is Jasper Report?', default='True')
    ...
    def create(self, values):
        ...
        if values['model'] in ('tr.wht','tr.wht.pnd'):
            values['jasper_report']= False
    ...
    def write(self, values):
        ...
        if self.model in ('tr.wht','tr.wht.pnd'):
            values['jasper_report']= False
